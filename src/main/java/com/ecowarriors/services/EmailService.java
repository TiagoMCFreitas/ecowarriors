...
public class EmailService {
    ...
    public EmailService() throws Exception {
        ...
        service = new Gmail.Builder(httpTransport, jsonFactory, getCredentials(httpTransport, jsonFactory))
                .setApplicationName("ProjetoEcowarriors")
                .build();
    }
    ...
    public void sendMail(String emailUsuario,String assunto, String mensagem) throws Exception {
        Properties props = new Properties();
        Session session = Session.getDefaultInstance(props, null);
        MimeMessage email = new MimeMessage(session);
        email.setFrom(new InternetAddress(TEST_EMAIL));
        email.addRecipient(TO, new InternetAddress(emailUsuario));
